...
#Read, train, and test the TXT file
...
Average_Data = aggregate(allData, by=list(activity = allData$activity, subject=allData$subject), mean)
# Remove the subject and activity column, since a mean of those has no use
Average_Data[,90] = NULL
Average_Data[,89] = NULL
write.table(Average_Data, "Average_Data", sep="\t")